...
function Product() {
  ...
  const ListProduct = async () => {
    try {
      const response = await axios.get('http://42store.duynguyen23.io.vn:5000/api/product');
  ...
  const getCategory = async () => {
    try {
      const responsive = await axios.get('http://42store.duynguyen23.io.vn:5000/api/category');
  ...
  const addCategory = async () => {
    const response = await axios.post('http://42store.duynguyen23.io.vn:5000/api/category', { category });
  ...
  const deleteCategory = async (id) => {
    try {
      await axios.delete(`http://42store.duynguyen23.io.vn:5000/api/category/${id}`);
      window.location.reload();
    } catch (error) {
  ...
  const deleteProduct = async (id) => {
    console.log('id', id);
    try {
      await axios.delete(`http://42store.duynguyen23.io.vn:5000/api/product/${id}`);
      window.location.reload();
    } catch (error) {
